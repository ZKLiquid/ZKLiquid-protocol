  ...
  return (
    <>
      <div className="text-white">
        ...
        <div className="mt-8">
          <div className="flex overflow-x-scroll flex-shrink-0 scroll-track-hide gap-4">
            {bridge.map(({ icon, name, price, id }, index) => (
              <div
                key={index}
                className="flex w-full items-center min-w-[272px] gap-3 bg-[#191A1F] rounded-xl p-3 hover:bg-opacity-80"
              >
                <img src={icon} alt="" />
                <div>
        ...
        <div className="md:flex flex-wrap md:flex-nowrap items-center bg-[#191A1F] gap-4 rounded-2xl mt-5 p-4 lg:pl-6">
          <svg
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="0.49074" stop-color="#B33BF6" />
                <stop offset="0.845877" stop-color="#FF844C" />
